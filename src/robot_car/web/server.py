...
</style></head><body><header><strong>钢球视觉监控</strong><span id="state">连接中</span></header><main class="layout"><section class="feed"><img id="frame" src="/video_feed" alt="实时相机画面"></section><aside>
