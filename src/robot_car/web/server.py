...
</style></head><body><header><strong>钢球识别</strong><span id="state">连接中</span></header><main class="layout"><section class="feed"><img id="frame" alt="实时相机画面"></section><aside>
...
class DebugServer:
    def __init__(self, host: str, port: int, status: JsonProvider,
                 results: JsonProvider, metrics: JsonProvider, frame: FrameProvider) -> None:
